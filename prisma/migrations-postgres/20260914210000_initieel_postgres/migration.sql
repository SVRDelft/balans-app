...
CREATE TABLE "Boekjaar" (
    ...
    CONSTRAINT "Boekjaar_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Relatie" (
    ...
    CONSTRAINT "Relatie_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Begrotingspost" (
    ...
    CONSTRAINT "Begrotingspost_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Factuurregel" (
    ...
    CONSTRAINT "Factuurregel_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Betaling" (
    ...
    "bedragCenten" INTEGER NOT NULL,
    "notitie" TEXT,
    "geregistreerdOp" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "Uitgave" (
    ...
    CONSTRAINT "Uitgave_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Bijlage" (
    ...
    "data" BYTEA NOT NULL,
    "geuploadOp" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "geuploadDoor" TEXT,

    CONSTRAINT "Bijlage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Omslagronde" (
    ...
    CONSTRAINT "Omslagronde_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OmslagrondeDeelnemer" (
    ...
    CONSTRAINT "OmslagrondeDeelnemer_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Banksaldo" (
    ...
    "notitie" TEXT,
    "ingevoerdOp" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "ingevoerdDoor" TEXT,

    CONSTRAINT "Banksaldo_pkey" PRIMARY KEY ("id")
);
